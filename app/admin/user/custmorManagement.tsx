      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-bold flex items-center gap-3">
            ...
            <span className="bg-linear-to-r from-yellow-500 to-green-500 bg-clip-text text-transparent">
              Customer Directory
            </span>
          </h1>
          <p className="text-zinc-500 text-sm mt-1">
            Track customer spending, orders, and contact details.
          </p>
        </div>
                ...
                >
                  <td className="p-5">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-xl bg-linear-to-br from-zinc-800 to-zinc-900 border border-zinc-700 flex items-center justify-center font-bold text-green-500 group-hover:border-green-500/50 transition-colors">
                  ...
                  <td className="p-5">
                    ...
                    <div className="text-xs text-zinc-500 mt-1 pl-6">
                      Total Spent:{" "}
                      <span className="text-green-500">{customer.spend}</span>
                    </div>
                  </td>
                  <td className="p-5">
                    <span
